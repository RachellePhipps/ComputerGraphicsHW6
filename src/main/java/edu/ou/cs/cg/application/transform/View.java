...
package edu.ou.cs.cg.application.transform;
	...
	implements GLEventListener
{
	...
	private void	drawMode(GLAutoDrawable drawable)
	{
		...
		renderer.draw(sc, 2, 72);
		renderer.draw(sn, 2, 86);
	...
	private static final	double		dx = 0.050;
	private static final	double		dy = 0.075;
	private static final	double		sx = 0.900;
	private static final	double		sy = 0.700;
	private static final	double		beta = 15.0;
